...
const data: Movie[] = [
  ...
  },
  {
    ...
    Response: "True",
    Images: [
      "https://images-na.ssl-images-amazon.com/images/M/MV5BMTk2MDMzMTc0MF5BMl5BanBnXkFtZTgwMTAyMzA1OTE@._V1_SX1500_CR0,0,1500,999_AL_jpg",
...
const getMovies = (): Promise<Movie[]> => {
  return Promise.resolve<Movie[]>(data);
};
